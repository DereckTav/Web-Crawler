...
public class TestUrlMarker {
  ...
  private static Stream<Arguments> getUrlMarkers() {
    return Stream.of(
        Arguments.of("hello@hello.com", "http", "hello", "", "hello.com", 80, "/", "", "",
            new int[]{-1, 0, 6, -1, -1, -1, -1}),
        Arguments.of("http://hello@hello.com", "http", "hello", "", "hello.com", 80, "/", "", "",
            new int[]{0, 7, 13, -1, -1, -1, -1}),
        Arguments.of("hello@hello.com", "http", "hello", "", "hello.com", 80, "/", "", "",
            new int[]{-1, 0, 6, -1, -1, -1, -1}),
        Arguments.of("https://user@google.com/h?hello=w#abc", "https", "user", "", "google.com", 443, "/h", "?hello=w", "#abc",
            new int[]{0, 8, 13, -1, 23, 25, 33}),
        Arguments.of("www.booopp.com:20#fa", "http", "", "", "www.booopp.com", 20, "/", "", "#fa",
            new int[]{-1, -1, 0, 15, -1, -1, 17}),
        Arguments.of("www.yahooo.com:20?fff#aa", "http", "", "", "www.yahooo.com", 20, "/", "?fff", "#aa",
            new int[]{-1, -1, 0, 15, -1, 17, 21}),
        Arguments.of("www.google.com#fa", "http", "", "", "www.google.com", 80, "/", "", "#fa",
            new int[]{-1, -1, 0, -1, -1, -1, 14}),
        Arguments.of("www.google.com?3fd#fa", "http", "", "", "www.google.com", 80, "/", "?3fd", "#fa",
            new int[]{-1, -1, 0, -1, -1, 14, 18}),
        Arguments.of("//www.google.com/", "", "", "", "www.google.com", -1, "/", "", "",
            new int[]{-1, -1, 2, -1, 16, -1, -1}),
        Arguments.of("http://www.google.com/", "http", "", "", "www.google.com", 80, "/", "", "",
            new int[]{0, -1, 7, -1, 21, -1, -1}),
        Arguments.of("ftp://whosdere:me@google.com/", "ftp", "whosdere", "me", "google.com", 21, "/", "", "",
            new int[]{0, 6, 18, -1, 28, -1, -1}),
        Arguments.of("ono:doope@fb.net:9090/dhdh", "http", "ono", "doope", "fb.net", 9090, "/dhdh", "", "",
            new int[]{-1, 0, 10, 17, 21, -1, -1}),
        Arguments.of("ono:a@fboo.com:90/dhdh/@1234", "http", "ono", "a", "fboo.com", 90, "/dhdh/@1234", "", "",
            new int[]{-1, 0, 6, 15, 17, -1, -1}),
        Arguments.of("fbeoo.net:990/dhdeh/@1234", "http", "", "", "fbeoo.net", 990, "/dhdeh/@1234", "", "",
            new int[]{-1, -1, 0, 10, 13, -1, -1}),
        Arguments.of("fbeoo:@boop.com/dhdeh/@1234?aj=r", "http", "fbeoo", "", "boop.com", 80, "/dhdeh/@1234", "?aj=r", "",
            new int[]{-1, 0, 7, -1, 15, 27, -1}),
        Arguments.of("bloop:@noooo.com/doop/@1234", "http", "bloop", "", "noooo.com", 80, "/doop/@1234", "", "",
            new int[]{-1, 0, 7, -1, 16, -1, -1}),
        Arguments.of("bah.com/lala/@1234/@dfd@df?@dsf#ono", "http", "", "", "bah.com", 80, "/lala/@1234/@dfd@df", "?@dsf",
            "#ono", new int[]{-1, -1, 0, -1, 7, 26, 31}),
        Arguments.of("https://dewd:dood@www.google.com:20/?why=is&this=test#?@Sdsf", "https", "dewd", "dood",
